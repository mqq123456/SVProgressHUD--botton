...
typedef NS_ENUM(NSUInteger, SVProgressHUDCenterType) {
    SVProgressHUDCenterMiddle,     // default animation type, custom flat animation (indefinite animated ring)
    SVProgressHUDCenterBotton    // iOS native UIActivityIndicatorView
};
...
@property (assign, nonatomic) SVProgressHUDCenterType centerStyle UI_APPEARANCE_SELECTOR;

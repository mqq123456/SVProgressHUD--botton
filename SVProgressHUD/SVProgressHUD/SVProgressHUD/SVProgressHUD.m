...
- (void)updatePosition {
    ...
    if (self.centerStyle == SVProgressHUDCenterBotton) {
        self.hudView.center = CGPointMake([UIScreen mainScreen].bounds.size.width/2, self.frame.size.height-80);
    }
}
...
- (NSTimeInterval)displayDurationForString:(NSString*)string {
    return (float)string.length*0.06 + 1.0;
}
...
- (UIColor *)hudStatusShadowColor {
    ...
    return [UIColor colorWithRed:101.0/255.0 green:101.0/255.0 blue:101.0/255.0 alpha:1];
}
